...
"cured" 1.0 0 -14070903 true "" "plot count turtles with [ cured? ]"
"death" 1.0 0 -16777216 true "" "plot sum-death"
"total sick" 1.0 0 -7858858 true "" "plot sum-sick"
...
"" ""
PENS
"GDP" 1.0 0 -13840069 true "" "plot sum-GDP"
"treat-cost" 1.0 0 -1184463 true "" "plot sum-cure-consume"
...
@#$#@#$#@
<experiments>
  <experiment name="experiment1" repetitions="3" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <timeLimit steps="140"/>
    <metric>count turtles with [ sick? ]</metric>
    <metric>count turtles with [ cured? ]</metric>
    <metric>sum-death</metric>
    <metric>sum-sick</metric>
    <metric>sum-GDP</metric>
    <metric>sum-cure-consume</metric>
    <enumeratedValueSet variable="average-GDP-oneday">
      <value value="2"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="turtle-shape">
      <value value="&quot;person&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="infected-with-protect">
      <value value="40"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="average-cured-time">
      <value value="20"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="initial-infected-percent">
      <value value="1"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="infected-without-protect">
      <value value="80"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="deathrate">
      <value value="5"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="average-cureconsume-oneday">
      <value value="9"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="grounded">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="masked">
      <value value="true"/>
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="average-symptomappear-time">
      <value value="11"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
